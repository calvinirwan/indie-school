(ns indie-school.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [indie-school.routes.home :refer [home-routes]]
            [indie-school.middleware :as middleware]
            [indie-school.session :as session]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[indie-school started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "indie-school is shutting down...")
  (stop-nrepl)
